...
This starts with the PooledV1 model (found in extra_packages/plenoptic_part in
...
across spatial scales. We then added on extra bells and whistles in order to
