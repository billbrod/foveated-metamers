...
rule paper_figures:
    input:
        ...
        op.join(config['DATA_DIR'], 'figures', 'paper', 'V1_norm_s6_gaussian', 'task-split_comp-met_mcmc_compare_psychophysical-grouplevel_log_yax-double'),
        op.join(config['DATA_DIR'], 'figures', 'paper', 'V1_norm_s6_gaussian', 'task-split_comp-ref_mcmc_compare_psychophysical-grouplevel_log_yax-double'),
        op.join(config['DATA_DIR'], 'figures', 'paper', 'RGC_norm_gaussian', 'task-split_comp-ref_mcmc_compare_psychophysical-grouplevel_log_yax-double'),
        op.join(config['DATA_DIR'], 'compose_figures', 'paper', 'V1_norm_s6_gaussian_comp-met_performance-all'),
        op.join(config['DATA_DIR'], 'compose_figures', 'paper', 'V1_norm_s6_gaussian_comp-ref_performance-all'),
        op.join(config['DATA_DIR'], 'compose_figures', 'paper', 'RGC_norm_gaussian_comp-ref_performance-all'),
        op.join(config['DATA_DIR'], 'statistics', 'critical_scaling.txt'),
        op.join(config['DATA_DIR'], 'statistics', 'number_of_stats.txt'),
