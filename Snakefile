...
rule paper_figures:
    input:
        ...
        op.join(config['DATA_DIR'], 'figures', 'paper', "V1_norm_s6_gaussian", "task-split_comp-ref_mcmc_partially-pooled_performance_focus-image.svg"),
        op.join(config['DATA_DIR'], 'figures', 'paper', "RGC_norm_gaussian", "task-split_comp-ref_mcmc_partially-pooled_performance_focus-image.svg"),
        op.join(config['DATA_DIR'], 'figures', 'paper', "V1_norm_s6_gaussian", "task-split_comp-met_mcmc_partially-pooled_performance_focus-image.svg"),
        op.join(config['DATA_DIR'], 'figures', 'paper', "RGC_norm_gaussian", "task-split_comp-met_mcmc_partially-pooled_performance_focus-image.svg"),
        ...
        op.join(config['DATA_DIR'], 'compose_figures', 'paper', 'metamer_comparison_rocks_scaling-1.5,1.5,1.5,1.5_cutout_dpi-300.svg'),
        op.join(config['DATA_DIR'], 'compose_figures', 'paper', 'metamer_comparison_ivy_scaling-.063,.063,.12,.12,.4,.4_cutout_natural-seed_dpi-300.svg'),
